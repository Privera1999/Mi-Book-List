...
public class Empezado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView3.getMenu().getItem(1).setChecked(false);
        ...
        if (Fband > 0) {
            ...
            for (int a = 1; a <= Fband; a++) {
                ...
                datosObtenidos = dbHelper.obtenerDatos(a,"Empezado");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(Empezado.this, EditarLibro.class);
